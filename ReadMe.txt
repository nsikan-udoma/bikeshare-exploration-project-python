...
4. Combine two columns of text in pandas dataframe
5. Lessons and practices in the Udcatiy - Masterschool Data Analysis Pre-Course Nanodegree Program
6. Recordings from the Pre-course student guide
7. Slack - Data Analysis Pre-Course Channel Resourcs.  Including pre_course_project_intro.ipynb file available at https://masterschool-campus.slack.com/archives/C03HKR2D6MU/p1657654420347839
8. __main__ — Top-level code environment. Available at https://docs.python.org/3/library/__main__.html
